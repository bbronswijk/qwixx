...
export const stepsTiles: Config = {
  [rows.a]: [
    { color: colors.red, value: 2, type: tileType.step },
    ...
    { color: colors.red, value: 8, type: tileType.step },
  ...
  [rows.b]: [
    ...
    { color: colors.yellow, value: 3, type: tileType.step },
    ...
    { color: colors.yellow, value: 7, type: tileType.step },
    { color: colors.yellow, value: 8, type: tileType.default },
    { color: colors.yellow, value: 9, type: tileType.step },
  ...
  [rows.c]: [
    ...
    { color: colors.green, value: 10, type: tileType.step },
    { color: colors.green, value: 9, type: tileType.default },
    { color: colors.green, value: 8, type: tileType.step },
    ...
    { color: colors.green, value: 4, type: tileType.step },
    { color: colors.green, value: 3, type: tileType.default },
    { color: colors.green, value: 2, type: tileType.step },
  ],
  [rows.d]: [
    ...
    { color: colors.blue, value: 9, type: tileType.step },
    ...
    { color: colors.blue, value: 3, type: tileType.step },
